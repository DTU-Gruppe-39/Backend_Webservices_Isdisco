...
namespace Isdisco_Web_API.DAO
{
    public class StorageSingleton
    {
        ...
        public StorageSingleton() 
        {
            ...
            musicrequestList.Add(new Musicrequest(FakeTracks[0], UserList[0].Id, new List<int>() { }, new List<int>() { 1, 2, 3 }, new List<User>() { UserList[0], UserList[1], UserList[2] }, new List<User>() { }));
            musicrequestList.Add(new Musicrequest(FakeTracks[1], UserList[1].Id, new List<int>() { }, new List<int>() { 1, 2, 3 }, new List<User>() { UserList[0], UserList[1], UserList[2] }, new List<User>() { }));
            musicrequestList.Add(new Musicrequest(FakeTracks[2], UserList[0].Id, new List<int>() { }, new List<int>() { 1, 2, 3 }, new List<User>() { UserList[0], UserList[1], UserList[2] }, new List<User>() { }));
            musicrequestList.Add(new Musicrequest(FakeTracks[3], UserList[1].Id, new List<int>() { }, new List<int>() { 1, 2, 3 }, new List<User>() { UserList[0], UserList[1], UserList[2] }, new List<User>() { }));
